...
@Component({
  selector: 'load-test-report',
  standalone: true,
  imports: [CommonModule, jqxWindowModule, jqxButtonModule],
  templateUrl: './load-test-report.component.html',
  styleUrl: './load-test-report.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class LoadTestReportComponent implements AfterViewInit {
