...
export class UiStateService {
  ...
  public registerSelectButtons(buttonItems: jqwidgets.ToolBarToolItem[], indices: number[], subject: Subject<EventInfo>): void {
  ...
  public registerToggleButton(buttonItem: jqwidgets.ToolBarToolItem, subject: Subject<EventInfo>) {
    buttonItem.tool.on('click', () => {
