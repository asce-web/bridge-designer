import { DesignGridService, DesignGrid, DesignGridDensity } from "./design-grid.service";
...
describe('DesignGridService', () => {
  ...
  it ('with finest grid endpoint should furnish finest grid', () =>{
    expect(draftingGridService.constantFinestGrid.density).toBe(DesignGridDensity.FINE);
  })
});
